...
namespace OpenGlobe.Examples
{
    sealed class CPURelativeToEye : IDisposable, IRenderable
    {
        ...
        {
            _sp = context.Device.CreateShaderProgram(
                EmbeddedResources.GetText("Chapter05Jitter.CPURelativeToEye.Shaders.VS.glsl"),
            ...
            //
            _positionBuffer = context.Device.CreateVertexBuffer(BufferHint.DynamicDraw, ArraySizeInBytes.Size(_positionsRelativeToEye));
