...
namespace OpenGlobe.Examples
{
    ...
    sealed class SceneGPURelativeToEyeLOD : IDisposable, IRenderable
    {
        ...
        {
            _spHigh = context.Device.CreateShaderProgram(
                EmbeddedResources.GetText("Chapter05Jitter.GPURelativeToEyeLOD.Shaders.HighPrecisionVS.glsl"),
                EmbeddedResources.GetText("Chapter05Jitter.Shaders.FS.glsl"));
            ...
            _positionBufferHigh = context.Device.CreateVertexBuffer(BufferHint.StaticDraw, ArraySizeInBytes.Size(positions));
            _positionBufferLow = context.Device.CreateVertexBuffer(BufferHint.StaticDraw, ArraySizeInBytes.Size(positions));
            _colorBuffer = context.Device.CreateVertexBuffer(BufferHint.StaticDraw, colors.Length);
            ...
            _spLow = context.Device.CreateShaderProgram(
                EmbeddedResources.GetText("Chapter05Jitter.GPURelativeToEyeLOD.Shaders.LowPrecisionVS.glsl"),
                EmbeddedResources.GetText("Chapter05Jitter.Shaders.FS.glsl"));
