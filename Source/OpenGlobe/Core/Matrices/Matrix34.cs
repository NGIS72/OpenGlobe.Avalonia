...
namespace OpenGlobe.Core
{
    ...
    public class Matrix34<T> : IEquatable<Matrix34<T>> where T : IEquatable<T>
    {
        ...
        public int NumberOfComponents => 12;

        public T Column0Row0 => _values[0];
        public T Column0Row1 => _values[1];
        public T Column0Row2 => _values[2];
        public T Column0Row3 => _values[3];

        public T Column1Row0 => _values[4];
        public T Column1Row1 => _values[5];
        public T Column1Row2 => _values[6];
        public T Column1Row3 => _values[7];

        public T Column2Row0 => _values[8];
        public T Column2Row1 => _values[9];
        public T Column2Row2 => _values[10];
        public T Column2Row3 => _values[11];
        ...
        /// </summary>
        public T[] ReadOnlyColumnMajorValues => _values;
