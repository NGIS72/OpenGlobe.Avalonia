...
namespace OpenGlobe.Core
{
    ...
    public class Matrix42<T> : IEquatable<Matrix42<T>> where T : IEquatable<T>
    {
        ...
        public T Column1Row0 => _values[2];
        public T Column1Row1 => _values[3];

        public T Column2Row0 => _values[4];
        public T Column2Row1 => _values[5];

        public T Column3Row0 => _values[6];
        public T Column3Row1 => _values[7];
