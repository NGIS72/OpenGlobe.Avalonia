...
namespace OpenGlobe.Core
{
    ...
    public class Matrix43<T> : IEquatable<Matrix43<T>> where T : IEquatable<T>
    {
        ...
        public T Column1Row0 => _values[3];
        public T Column1Row1 => _values[4];
        public T Column1Row2 => _values[5];

        public T Column2Row0 => _values[6];
        public T Column2Row1 => _values[7];
        public T Column2Row2 => _values[8];

        public T Column3Row0 => _values[9];
        public T Column3Row1 => _values[10];
        public T Column3Row2 => _values[11];
