...
namespace OpenGlobe.Core
{
    ...
    public class Matrix4F
    {
        ...
        public float Column0Row0 => _values[0];
        public float Column0Row1 => _values[1];
        public float Column0Row2 => _values[2];
        public float Column0Row3 => _values[3];

        public float Column1Row0 => _values[4];
        public float Column1Row1 => _values[5];
        public float Column1Row2 => _values[6];
        public float Column1Row3 => _values[7];

        public float Column2Row0 => _values[8];
        public float Column2Row1 => _values[9];
        public float Column2Row2 => _values[10];
        public float Column2Row3 => _values[11];

        public float Column3Row0 => _values[12];
        public float Column3Row1 => _values[13];
        public float Column3Row2 => _values[14];
        public float Column3Row3 => _values[15];
        ...
        /// </summary>
        public float[] ReadOnlyColumnMajorValues => _values;
