...
namespace OpenGlobe.Core
{
    ...
    {
        public static Vector2H Zero => new Vector2H(0.0f, 0.0f);

        public static Vector2H UnitX => new Vector2H(1.0f, 0.0f);

        public static Vector2H UnitY => new Vector2H(0.0f, 1.0f);

        public static Vector2H Undefined => new Vector2H(Half.NaN, Half.NaN);
        ...
        public bool IsUndefined => _x.IsNaN;
