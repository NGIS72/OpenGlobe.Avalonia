...
namespace OpenGlobe.Core
{
    ...
    public struct Vector3D : IEquatable<Vector3D>
    {
        ...
        public static Vector3D Undefined => new Vector3D(Double.NaN, Double.NaN, Double.NaN);
        ...
        public double MagnitudeSquared => _x * _x + _y * _y + _z * _z;
        ...
        public double MaximumComponent => Math.Max(Math.Max(_x, _y), _z);

        public double MinimumComponent => Math.Min(Math.Min(_x, _y), _z);
