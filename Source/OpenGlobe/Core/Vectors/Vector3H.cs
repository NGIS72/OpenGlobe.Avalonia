...
namespace OpenGlobe.Core
{
    ...
    {
        public static Vector3H Zero => new Vector3H(0.0, 0.0, 0.0);

        public static Vector3H UnitX => new Vector3H(1.0, 0.0, 0.0);

        public static Vector3H UnitY => new Vector3H(0.0, 1.0, 0.0);

        public static Vector3H UnitZ => new Vector3H(0.0, 0.0, 1.0);

        public static Vector3H Undefined => new Vector3H(Half.NaN, Half.NaN, Half.NaN);
