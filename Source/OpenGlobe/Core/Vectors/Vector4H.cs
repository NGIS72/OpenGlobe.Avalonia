...
namespace OpenGlobe.Core
{
    ...
    {
        public static Vector4H Zero => new Vector4H(0.0, 0.0, 0.0, 0.0);

        public static Vector4H UnitX => new Vector4H(1.0, 0.0, 0.0, 0.0);

        public static Vector4H UnitY => new Vector4H(0.0, 1.0, 0.0, 0.0);

        public static Vector4H UnitZ => new Vector4H(0.0, 0.0, 1.0, 0.0);

        public static Vector4H UnitW => new Vector4H(0.0, 0.0, 0.0, 1.0);

        public static Vector4H Undefined => new Vector4H(Half.NaN, Half.NaN, Half.NaN, Half.NaN);
        ...
        public Vector2H XY => new Vector2H(X, Y);

        public Vector3H XYZ => new Vector3H(X, Y, Z);

        public bool IsUndefined => Double.IsNaN(_x);
