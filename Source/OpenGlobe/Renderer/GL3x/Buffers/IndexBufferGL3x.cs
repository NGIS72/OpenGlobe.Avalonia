...
namespace OpenGlobe.Renderer.GL3x
{
    internal class IndexBufferGL3x : IndexBuffer
    {
        ...
        public override int SizeInBytes => _bufferObject.SizeInBytes;

        public override BufferHint UsageHint => _bufferObject.UsageHint;

        public override IndexBufferDatatype Datatype => _dataType;
