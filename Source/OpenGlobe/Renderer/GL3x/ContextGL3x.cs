...
namespace OpenGlobe.Renderer.GL3x
{
    internal class ContextGL3x : Context
    {
        public ContextGL3x(int width, int height)
        {
            ...
            _clearColor = new Avalonia.Media.Color(
                Convert.ToByte(clearColor.W * 255.0), 
                Convert.ToByte(clearColor.X * 255.0), 
                Convert.ToByte(clearColor.Y * 255.0),
                Convert.ToByte(clearColor.Z * 255.0));
            ...
            Viewport = new Avalonia.PixelRect(0, 0, width, height);
        ...
        private static void ForceApplyRenderState(RenderState renderState)
        {
            ...
            GL.PolygonMode(TriangleFace.FrontAndBack, TypeConverterGL3x.To(renderState.RasterizationMode));

            Enable(EnableCap.ScissorTest, renderState.ScissorTest.Enabled);
            var rectangle = renderState.ScissorTest.Rectangle;
            ...
            var blendColor = renderState.Blending.Color;
            GL.BlendColor(blendColor.R / 255f, blendColor.G / 255f, blendColor.B / 255f, blendColor.A / 255f);
        ...
        {
            return new VertexArrayGL3x(this);
        }

        public override Framebuffer CreateFramebuffer()
        {
            return new FramebufferGL3x(this);
        }

        public override TextureUnits TextureUnits => _textureUnits;

        public override Avalonia.PixelRect Viewport
        {
            get
            {
                return _viewport;
        ...
        public override void Clear(ClearState clearState)
        {
            ...
            {
                var r = clearState.Color.R / 255f;
                var g = clearState.Color.G / 255f;
                var b = clearState.Color.B / 255f;
                var a = clearState.Color.A / 255f;
        ...
        public override void Draw(Core.PrimitiveType primitiveType, int offset, int count, DrawState drawState, SceneState sceneState)
        {
        ...
        public override void Draw(Core.PrimitiveType primitiveType, DrawState drawState, SceneState sceneState)
        {
            VerifyDraw(drawState, sceneState);
            ApplyBeforeDraw(drawState, sceneState);
        ...
        private void ApplyRasterizationMode(RasterizationMode rasterizationMode)
        {
            ...
            {
                GL.PolygonMode(TriangleFace.FrontAndBack, TypeConverterGL3x.To(rasterizationMode));
        ...
        private Avalonia.Media.Color _clearColor;
