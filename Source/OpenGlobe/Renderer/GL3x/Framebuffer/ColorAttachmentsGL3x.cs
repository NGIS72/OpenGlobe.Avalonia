...
namespace OpenGlobe.Renderer.GL3x
{
    ...
    {
        public ColorAttachmentsGL3x(Context context)
        {
            _colorAttachments = new ColorAttachmentGL3x[context.Device.MaximumNumberOfColorAttachments];
        }
        ...
        internal ColorAttachmentGL3x[] Attachments => _colorAttachments;
