...
namespace OpenGlobe.Renderer.GL3x
{
    ...
    {
        public FramebufferGL3x(Context context)
        {
            _name = new FramebufferNameGL3x();
            _colorAttachments = new ColorAttachmentsGL3x(context);
        }
        ...
        public override ColorAttachments ColorAttachments => _colorAttachments;
