...
namespace OpenGlobe.Renderer.GL3x
{
    internal class ShaderProgramGL3x : ShaderProgram, ICleanableObserver
    {
        public ShaderProgramGL3x(
            ...
            : this(context, vertexShaderSource, string.Empty, fragmentShaderSource)
        {
        }
        ...
        internal ShaderProgramNameGL3x Handle => _program;
        ...
        private string ProgramInfoLog => GL.GetProgramInfoLog(_program.Value);

        #region ShaderProgram Members

        public override string Log => ProgramInfoLog;

        public override FragmentOutputs FragmentOutputs => _fragmentOutputs;

        public override ShaderVertexAttributeCollection VertexAttributes => _vertexAttributes;

        public override UniformCollection Uniforms => _uniforms;

        public override UniformBlockCollection UniformBlocks => _uniformBlocks;
