...
namespace OpenGlobe.Renderer.GL3x
{
    internal class Texture2DGL3x : Texture2D
    {
        ...
        public Texture2DGL3x(Device device, Texture2DDescription description, TextureTarget textureTarget)
        {
            ...
            _lastTextureUnit = OpenTKTextureUnit.Texture0 + (m_Device.NumberOfTextureUnits - 1);
            ...
            //
            ApplySampler(m_Device.TextureSamplers.LinearClamp);

            GC.AddMemoryPressure(description.ApproximateSizeInBytes);
        }

        internal TextureNameGL3x Handle => _name;
        ...
        public override Texture2DDescription Description => _description;
