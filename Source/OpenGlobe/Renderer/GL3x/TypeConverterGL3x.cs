...
namespace OpenGlobe.Renderer.GL3x
{
    internal static class TypeConverterGL3x
    {
        ...
        public static BeginMode To(Core.PrimitiveType type)
        {
            switch (type)
            {
                case Core.PrimitiveType.Points:
                    return BeginMode.Points;
                case Core.PrimitiveType.Lines:
                    return BeginMode.Lines;
                case Core.PrimitiveType.LineLoop:
                    return BeginMode.LineLoop;
                case Core.PrimitiveType.LineStrip:
                    return BeginMode.LineStrip;
                case Core.PrimitiveType.Triangles:
                    return BeginMode.Triangles;
                case Core.PrimitiveType.TriangleStrip:
                    return BeginMode.TriangleStrip;
                case Core.PrimitiveType.LinesAdjacency:
                    return BeginMode.LinesAdjacency;;
                case Core.PrimitiveType.LineStripAdjacency:
                    return BeginMode.LineStripAdjacency;
                case Core.PrimitiveType.TrianglesAdjacency:
                    return BeginMode.TrianglesAdjacency;
                case Core.PrimitiveType.TriangleStripAdjacency:
        ...
        public static TriangleFace To(CullFace face)
        {
            switch (face)
            {
                case CullFace.Front:
                ...
                case CullFace.FrontAndBack:
                    return TriangleFace.FrontAndBack;
            }
