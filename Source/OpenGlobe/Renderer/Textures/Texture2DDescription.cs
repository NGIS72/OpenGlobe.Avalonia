...
namespace OpenGlobe.Renderer
{
    public struct Texture2DDescription : IEquatable<Texture2DDescription>
    {
        ...
        public bool DepthStencilRenderable => _format == TextureFormat.Depth24Stencil8 ||
                    _format == TextureFormat.Depth32fStencil8;
        ...
        /// </summary>
        public int ApproximateSizeInBytes => _width * _height * SizeInBytes(_format);
