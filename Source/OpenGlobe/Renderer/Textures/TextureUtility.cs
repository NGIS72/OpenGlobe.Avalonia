    ...
    public static class TextureUtility
    {
        ...
        public static ImageFormat ImagingPixelFormatToImageFormat(ImagingPixelFormat pixelFormat)
        {
            ...
            switch (pixelFormat)
            {
                ...
                case ImagingPixelFormat.Rgb888x:
                case ImagingPixelFormat.Rgb565:
                case ImagingPixelFormat.Rgb101010x:
                    return ImageFormat.RedGreenBlue;

                case ImagingPixelFormat.Argb4444:
                case ImagingPixelFormat.Rgba8888:
                case ImagingPixelFormat.Rgba1010102:
                case ImagingPixelFormat.RgbaF16Clamped:
                case ImagingPixelFormat.RgbaF16:
                case ImagingPixelFormat.RgbaF32:
                case ImagingPixelFormat.Rgba16161616:
                    return ImageFormat.RedGreenBlueAlpha;

                case ImagingPixelFormat.Bgra8888:
                case ImagingPixelFormat.Bgra1010102:
                    return ImageFormat.BlueGreenRedAlpha;

                case ImagingPixelFormat.Gray8:
                case ImagingPixelFormat.AlphaF16:
                case ImagingPixelFormat.Alpha16:
                    return ImageFormat.DepthComponent;
                    
                case ImagingPixelFormat.Rg88:
                case ImagingPixelFormat.RgF16:
                case ImagingPixelFormat.Rg1616:
                    return ImageFormat.RedGreen;

                case ImagingPixelFormat.Bgr101010x:
        ...
        public static bool Supported(ImagingPixelFormat pixelFormat)
        {
            return pixelFormat != ImagingPixelFormat.Unknown;
        }
