...
namespace OpenGlobe.Scene
{
    ...
    /// </summary>
    public sealed class CameraLookAtPoint : IDisposable, ICameraView
    {
        /// <summary>
        ...
        public CameraLookAtPoint(Camera camera, Ellipsoid ellipsoid)
        {
            if (camera == null)
            {
        ...
        /// <param name="window">The window in which the scene is drawn.</param>
        /// <param name="ellipsoid">The ellipsoid defining the shape of the globe.</param>
        public CameraLookAtPoint(Camera camera) :
            this(camera, Ellipsoid.UnitSphere)
        {
        }
        ...
        private void Rotate(Avalonia.Controls.Control view, Size movement)
        {
            ...
            double azimuthWindowRatio = (double)movement.Width / (double)view.Bounds.Width;
            double elevationWindowRatio = (double)movement.Height / (double)view.Bounds.Height;
        ...
        private void Zoom(Avalonia.Controls.Control view, Size movement)
        {
            ...
            double rangeWindowRatio = (double)movement.Height / (double)view.Bounds.Height;
