...
{
    public sealed class RayCastedGlobe : IDisposable, IRenderable
    {
        ...
        public RayCastedGlobe(Context context)
        {
            ...
            ShaderProgram sp = m_Context.Device.CreateShaderProgram(vs, EmbeddedResources.GetText("OpenGlobe.Scene.Globes.RayCasted.Shaders.GlobeFS.glsl"));
            ...
            ShaderProgram solidSP = m_Context.Device.CreateShaderProgram(vs, EmbeddedResources.GetText("OpenGlobe.Scene.Globes.RayCasted.Shaders.SolidShadedGlobeFS.glsl"));
