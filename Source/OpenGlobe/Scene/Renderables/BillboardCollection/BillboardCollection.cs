...
{
    public sealed class BillboardCollection : IList<Billboard>, IDisposable, IRenderable
    {
        ...
        private void CreateVertexArray(Context context)
        {
            ...
            _positionBuffer = m_Context.Device.CreateVertexBuffer(BufferHint.StaticDraw, _billboards.Count * SizeInBytes<Vector3F>.Value);
            _colorBuffer = m_Context.Device.CreateVertexBuffer(BufferHint.StaticDraw, _billboards.Count * SizeInBytes<BlittableRGBA>.Value);
            _originBuffer = m_Context.Device.CreateVertexBuffer(BufferHint.StaticDraw, _billboards.Count);
            _pixelOffsetBuffer = m_Context.Device.CreateVertexBuffer(BufferHint.StaticDraw, _billboards.Count * SizeInBytes<Vector2H>.Value);
            _textureCoordinatesBuffer = m_Context.Device.CreateVertexBuffer(BufferHint.StaticDraw, _billboards.Count * SizeInBytes<Vector4H>.Value);
        ...
        public int Count => _billboards.Count;
        ...
        public bool IsReadOnly => _billboards.IsReadOnly;
