...
{
    public sealed class Plane : IDisposable, IRenderable
    {
        ...
        public Plane(Context context)
        {
            ...
            ShaderProgram lineSP = m_Context.Device.CreateShaderProgram(
            ...
            OutlineWidth = 1;
            OutlineColor = Avalonia.Media.Colors.Gray;
            ...
            ShaderProgram fillSP = m_Context.Device.CreateShaderProgram(
            ...
            FillColor = Avalonia.Media.Colors.Gray;
            FillTranslucency = 0.5f;

            ///////////////////////////////////////////////////////////////////

            _positionBuffer = m_Context.Device.CreateVertexBuffer(BufferHint.StaticDraw, 2 * 4 * SizeInBytes<Vector3F>.Value);
            ...
            IndexBuffer indexBuffer = m_Context.Device.CreateIndexBuffer(BufferHint.StaticDraw, indices.Length * sizeof(ushort));
        ...
        private Avalonia.Media.Color _lineColor;
        ...
        private Avalonia.Media.Color _fillColor;
