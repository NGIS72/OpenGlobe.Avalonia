...
{
    public sealed class OutlinedPolylineTexture : IDisposable, IRenderable
    {
        ...
        public void Set(Context context, Mesh mesh)
        {
            ...
            {
                _drawState.ShaderProgram = m_Context.Device.CreateShaderProgram(
            ...
            ///////////////////////////////////////////////////////////////////
            _meshBuffers = m_Context.Device.CreateMeshBuffers(mesh, _drawState.ShaderProgram.VertexAttributes, BufferHint.StaticDraw);
        ...
        private void Update(Context context, SceneState sceneState)
        {
            ...
            if ((_texture == null) || (_texture.Description.Width != textureWidth))
            {
                ...
                _texture = m_Context.Device.CreateTexture2D(new Texture2DDescription(textureWidth, 1, TextureFormat.RedGreen8));
