...
namespace OpenGlobe.Scene
{
    public sealed class PolylineOnTerrain : IDisposable
    {
        ...
        public PolylineOnTerrain(Context context)
        {
            m_Context = context;
            _wallSP = m_Context.Device.CreateShaderProgram(
            ...
            _shadowVolumeSP = m_Context.Device.CreateShaderProgram(
        ...
        public void Set(Context context, IList<Vector3D> positions)
        {
            ...
            IndexBuffer indexBuffer = m_Context.Device.CreateIndexBuffer(BufferHint.StaticDraw, numIndices * sizeof(ushort));
