...
{
    public sealed class TriangleMeshTerrainTile : IDisposable, IRenderable
    {
        ...
        public TriangleMeshTerrainTile(Context context, TerrainTile tile)
        {
            ...
            ShaderProgram silhouetteSP = m_Context.Device.CreateShaderProgram(
        ...
        private void CreateDepthAndSilhouetteData(Context context)
        {
                ...
                (_depthTexture.Description.Height != context.Viewport.Height))
            {
                ...
                // Textures
                //
                _depthTexture = m_Context.Device.CreateTexture2D(new Texture2DDescription(context.Viewport.Width, context.Viewport.Height, TextureFormat.Depth24));
                _silhouetteTexture = m_Context.Device.CreateTexture2D(new Texture2DDescription(context.Viewport.Width, context.Viewport.Height, TextureFormat.Red8));
                _colorTexture = m_Context.Device.CreateTexture2D(new Texture2DDescription(context.Viewport.Width, context.Viewport.Height, TextureFormat.RedGreenBlue8));
        ...
        public Texture2D SilhouetteTexture => _silhouetteTexture;
