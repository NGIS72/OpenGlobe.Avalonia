...
namespace OpenGlobe.Scene
{
    ...
    public sealed class VertexDisplacementMapTerrainTile : IDisposable, IRenderable
    {
        ...
        public VertexDisplacementMapTerrainTile(Context context, TerrainTile tile)
        {
            ...
            //
            WritePixelBuffer pixelBuffer = m_Context.Device.CreateWritePixelBuffer(PixelBufferHint.Stream,
                sizeof(float) * tile.Heights.Length);
            pixelBuffer.CopyFromSystemMemory(tile.Heights);

            _texture = m_Context.Device.CreateTexture2DRectangle(new Texture2DDescription(
            ...
            ShaderProgram spTerrain = m_Context.Device.CreateShaderProgram(
            ...
            ShaderProgram spNormals = m_Context.Device.CreateShaderProgram(
            ...
            ShaderProgram spWireframe = m_Context.Device.CreateShaderProgram(
        ...
        public void Render(Context context, SceneState sceneState)
        {
            ...
            if (ShowTerrain || ShowSilhouette || ShowWireframe || ShowNormals)
            {
                ...
                context.TextureUnits[0].TextureSampler = m_Context.Device.TextureSamplers.NearestClamp;

                context.TextureUnits[6].Texture = ColorMapTexture;
                context.TextureUnits[6].TextureSampler = m_Context.Device.TextureSamplers.LinearClamp;

                context.TextureUnits[1].Texture = ColorRampHeightTexture;
                context.TextureUnits[1].TextureSampler = m_Context.Device.TextureSamplers.LinearClamp;

                context.TextureUnits[7].Texture = ColorRampSlopeTexture;
                context.TextureUnits[7].TextureSampler = m_Context.Device.TextureSamplers.LinearClamp;

                context.TextureUnits[2].Texture = BlendRampTexture;
                context.TextureUnits[2].TextureSampler = m_Context.Device.TextureSamplers.LinearClamp;

                context.TextureUnits[3].Texture = GrassTexture;
                context.TextureUnits[3].TextureSampler = m_Context.Device.TextureSamplers.LinearRepeat;

                context.TextureUnits[4].Texture = StoneTexture;
                context.TextureUnits[4].TextureSampler = m_Context.Device.TextureSamplers.LinearRepeat;

                context.TextureUnits[5].Texture = BlendMaskTexture;
                context.TextureUnits[5].TextureSampler = m_Context.Device.TextureSamplers.LinearClamp;
